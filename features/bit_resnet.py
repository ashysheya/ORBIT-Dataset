...
def resnet50(pretrained=False, pretrained_model_path=None, batch_norm='basic', with_film=False, **kwargs):
    """
        Constructs a ResNet-50 FiLM model.
    """
    if with_film:
        model = FilmResNetV2([3, 4, 6, 3], 1, **kwargs)
    else:
